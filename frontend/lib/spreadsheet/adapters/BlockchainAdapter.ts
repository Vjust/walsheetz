...
import { browserWalletManager, browserSuiService, AtomicOperationManager, createWalrusStorageOp, createTxPrepOp, createBlockchainExecutionOp } from '../../../walrus-sui-core/src/blockchain-integration/index.js';
import { browserWalrusService, logger, LogComponent, configLoader, eventBus as transactionEventBus } from '../../../walrus/src/index.js';
// Collaboration disabled for single-user MVP
import { collaborationService } from '../services/CollaborationService.js';
// Import transaction and offline services from walrus-sui-core
import { transactionExperienceManager, transactionManager, offlineModeService } from '../../../walrus-sui-core/src/transaction-management/index.js';

// ErrorCategory stub (not exported from walrus)
const ErrorCategory = { NETWORK: 'network', WALLET: 'wallet', CONTRACT: 'contract', STORAGE: 'storage', UNKNOWN: 'unknown' };
