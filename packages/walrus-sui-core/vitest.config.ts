...
export default defineConfig({
  resolve: {
    alias: [
      {
        find: '@dreamlit/walrus-sui-core/blockchain',
        replacement: path.join(packageDir, 'src', 'blockchain', 'index.ts'),
      },
      {
        find: '@dreamlit/walrus-sui-core/blockchain-integration',
        replacement: path.join(packageDir, 'src', 'blockchain-integration', 'index.ts'),
      },
      {
        find: '@dreamlit/walrus-sui-core/dist/blockchain/index.js',
        replacement: path.join(packageDir, 'src', 'blockchain', 'index.ts'),
      },
      {
        find: '@dreamlit/walrus-sui-core/dist/blockchain-integration/index.js',
        replacement: path.join(packageDir, 'src', 'blockchain-integration', 'index.ts'),
      },
      {
        find: '@dreamlit/walrus-sui-core/transaction',
        replacement: path.join(packageDir, 'src', 'transaction-management', 'index.ts'),
      },
      {
        find: '@dreamlit/walrus-sui-core/data-integrity',
        replacement: path.join(packageDir, 'src', 'data-integrity', 'index.ts'),
      },
