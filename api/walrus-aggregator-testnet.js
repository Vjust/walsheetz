 ...
 * Proxies requests to Walrus testnet aggregator endpoint with proper CORS headers
 */
...
export default async function handler(req) {
  ...
  const upstreamPath = pathname.replace('/api/walrus-aggregator-testnet', '')
  ...
  try {
    // Aggregator is primarily GET/HEAD, but handle POST just in case
    let body = undefined
